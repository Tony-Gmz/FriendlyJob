    ...
    <Modal trigger={<Button className="modal_button_trigger">Inscription </Button>} closeIcon>
      ...
      <Modal.Content image scrolling>
        <Modal.Description>
          ...
          <div className="modal_inscription_info"><i className="info circle icon" />Les champs suivis de * sont obligatoire pour l'inscription</div>
          {isSubscribe && (
          <Snackbar
            open={isOpen}
...
ModalInscription.propTypes = {
  ...
  closeErrorMessageInscription: PropTypes.func.isRequired,
  ...
  errorInscriptionMessage: PropTypes.bool.isRequired,
