...
function (_React$Component) {
  ...
  _proto.getTreeNodeProps = function getTreeNodeProps(node, layer, index) {
    ...
    return {
      ...
      nodeData: (0, _extends3.default)({}, node, {
        expand: expand
      }),
  ...
  _proto.renderNode = function renderNode(node, index, layer) {
    ...
    var nodeProps = (0, _extends3.default)({}, this.getTreeNodeProps(node, layer, index), {
  ...
  _proto.renderVirtualNode = function renderVirtualNode(node, options) {
    ...
    var nodeProps = (0, _extends3.default)({}, this.getTreeNodeProps(node, layer), {
      style: style,
  ...
  _proto.render = function render() {
    var _this$props20 = this.props,
        ...
        rest = (0, _objectWithoutPropertiesLoose2.default)(_this$props20, ["inline", "locale", "disabled", "toggleComponentClass", "placeholder", "cleanable", "renderValue", "valueKey", "labelKey", "onEntered", "onExited", "onClean", "style"]);
    var activeNode = this.state.activeNode;
